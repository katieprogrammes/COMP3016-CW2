...
//Error checking
void glfwErrorCallback(int error, const char* description) { std::cerr << "GLFW Error " << error << ": " << description << std::endl; }
...
int main()
{
    ...
    glm::vec3 pointLightPosition = glm::vec3(0.0f, 20.f, 0.0f);
